...
//     assert_eq!(
//         test_struct.spore_print(),
//         "ComplexStruct { ref_field: Hello, vec_field: [1, 2, 3], option_field: World }"
//     );
// }
//
...
// }
//
// // Edge case: Enum with no variants
// #[derive(SporePrint)]
// enum NoVariantsEnum {}
//
// #[test]
// fn test_no_variants_enum() {
//     let result: Result<(), Box<dyn std::any::Any + Send>> = std::panic::catch_unwind(|| {
//         // This should cause a panic since the enum has no variants
//         // let instance = NoVariantsEnum {}; // This line is incorrect and should be removed
